...
with lib;
let
  stateDir = "${config.xdg.dataHome}/clamav";
  runDir = "${config.xdg.stateHome}/clamav";
...
in
{
  ...
  config = mkIf (cfg.updater.enable || cfg.daemon.enable) {
    ...
    xdg.configFile."clamav/freshclam.conf".source = freshclamConfigFile;
    xdg.configFile."clamav/clamd.conf".source = clamdConfigFile;
